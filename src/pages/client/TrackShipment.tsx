                    ...
                    {STATUS_STEPS.map((step, index) => {
                     ...
                     // 2. STYLING LOGIC
                      ...
                      if (isCancelled && isCurrent) {
                        ...
                        // borderColor = "border-red-600"; // ✅ Updates to red
                      } 
                      // If cancelled, future steps are greyed out
                         ...
                         // No need to update borderColor here, it keeps the default "border-slate-300"
                      }
                      // Normal Current State
                        ...
                        // borderColor = "border-green-600"; // ✅ Updates to green
                      }
